...
if(isset($_POST['registerbutton'])){register();}
?>
  ...
  <div class="container mt-5">
    <div class="row justify-content-center">
      <div class="col-md-6">
        ...
        <p class="mt-3 text-center">Already have an account? <a href="http://localhost/coursework/login.php" id="register-link">Login</a></p>
      </div>
    </div>
  </div>
